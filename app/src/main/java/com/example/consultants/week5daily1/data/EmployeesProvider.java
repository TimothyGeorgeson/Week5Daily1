package com.example.consultants.week5daily1.data;
...
public class EmployeesProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.example.consultants.week5daily1.data.EmployeesProvider";
    ...
    static final String DATABASE_NAME = "Business";
